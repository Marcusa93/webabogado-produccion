...
export default function UnifiedCard({
  ...
  const variants = {
    light: {
      card: 'bg-card/50 backdrop-blur-sm border-foreground/5 hover:shadow-strong',
      text: 'text-foreground',
      description: 'text-foreground/60',
    },
    dark: {
      card: 'bg-card border-foreground/10 hover:shadow-2xl hover:border-accent/40',
      text: 'text-foreground',
      description: 'text-foreground/60',
    },
    glass: {
      card: 'bg-background/40 border-foreground/10 backdrop-blur-md hover:shadow-strong',
      text: 'text-foreground',
      description: 'text-foreground/60',
    },
  };
